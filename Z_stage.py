...
class ZStage():
    ...
    def settings(self, lib, id):
        ...
        class BorderFlags_:
            ...
            BORDER_STOP_LEFT = 2
            BORDER_IS_ENCODER = 1
        edges_settings.BorderFlags = BorderFlags_.BORDER_STOP_RIGHT | BorderFlags_.BORDER_STOP_LEFT | BorderFlags_.BORDER_IS_ENCODER
        class EnderFlags_:
...
def main():
    ...
    try:
        ...
        print(f'Time taken is {time.perf_counter() - zero_time}')
    except:
        stage.close()
    finally:
        stage.close()
